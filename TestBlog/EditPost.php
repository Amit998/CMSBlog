...
if(isset($_POST["Submit"])){
    ...
    if(empty($PostTitle)){
        ...
        $sql ="UPDATE posts SET title='$PostTitle', category='$categoryTitle' ,image='$imageName', post='$PostDescription'  WHERE id='$SearchQueryParameter' ";
        $Execute=$ConnectDB->query($sql);
        move_uploaded_file($tmp_dir,$upload_dir.$imageName);
    }
    else{
        $sql ="UPDATE posts SET title='$PostTitle', category='$categoryTitle', post='$PostDescription'  WHERE id='$SearchQueryParameter' ";
        $Execute=$ConnectDB->query($sql);
    ...
    <section class="container py-2 md-4">
        ...
        <div class="offset-lg-1 col-lg-10" style="min-height:400px;">
            ...
            while($DataRows=($stmtPost->fetch())){
                ...
                $PostTextToBeUpdated   =$DataRows["post"];
            }
                    ...
                    <div class="card-body bg-dark"> 
                        <div class="form-group">
                            <label for="title"><span class="field-Info">Add New Category</span></label>
                                <input class="form-control" type="text" name="PostTitle" id="Title" placeholder="Enter The Title Here" value="<?php echo $TitleToBeUpdated ;?>">
                        </div>

                        <div class="form-group">
                            <span class="FieldInfo">Existing Category:</span>
                            <span class="Text-bold"><?php echo $CategoryToBeUpdated;?></span>
                            <br>
                        ...
                        <div class="form-group">
                                ...
                                <img class="ml-2" src="Uploads/<?php echo$ImageToBeUpdated ;?>" alt="" height="120px" width="120px" >
                                <br>
                        
                                <div class="custom-file mb-1 mt-3">
                                <input class="form-control custom-file-input" type="file" name="Image" id="ImageSelect" placeholder="Enter The Title Here" value="<?php echo $TitleToBeUpdated ;?>">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="PostDescription" id="Post" cols="30" rows="10" placeholder="Write The Post Here">
                            <?php echo$PostTextToBeUpdated ;?>
                            </textarea>
                        </div>
